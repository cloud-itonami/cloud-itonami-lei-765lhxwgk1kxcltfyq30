...
This repository archives the publicly published Terms of Use of Pfizer
Inc., per ADR-2607110300 -- a read-only reference archive. As part of a
...
- **Company**: Pfizer Inc., LEI 765LHXWGK1KXCLTFYQ30, website
  `https://www.pfizer.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.pfizer.com/terms`,
